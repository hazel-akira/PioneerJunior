      ...
      <section className="relative h-[100vh] bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('/images/join.JPG')" }}>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-4 justify-center">
            ...
            <Link to="https://enquireto.pioneergroupofschools.co.ke" className="inline-block border mb-6 border-[#bdd6f0] bg-[#e4af23]  px-8 py-3 text-2xl font-bold uppercase text-white hover:bg-[#bdd6f0] hover:text-[#0C356A] transition-colors rounded"
            >  Join to Register 
            </Link>
          </div>
        </div>
