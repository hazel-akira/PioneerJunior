...
const JoinGrade6: React.FC = () => {
  return (
    ...
    <> 
     <Helmet>
    <title> Join Grade 8 | Pioneer Junior Academy </title>
    </Helmet>
    ...
    <main className="flex-grow max-w-4xl mx-auto px-4 py-12 space-y-12" >
      ...
      <section>
        <h2 className="text-3xl font-bold text-white mb-4">
          Eligibility Requirements for Joining Grade 8
        </h2>  
      ...
      <section>
        ...
        <ul className="list-decimal list-inside space-y-2 text-xl  text-gray-100">
          ...
          <li>
          The student must provide an original CBC result certificate for Grade 7. (Please first supply us with the original; a copy of the original will be kept by the school) 
          </li>
          <li>
...
<section className="flex flex-col sm:flex-row gap-4 justify-center">
    ...
    <a
      href="https://enquireto.pioneergroupofschools.co.ke/main/register?school=pioneerjunioracademy.co.ke"
      target="_blank"
      rel="noopener"
